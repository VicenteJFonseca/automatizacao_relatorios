...
### OBJETIVO
Este relatório foi desenvolvido para munir, de forma ágil, o coordenador do BIOCEN das informações necessárias para tomada de decisões e aplicação de estratégias internas no âmbito da Universidade com o intuito de obter recursos para investimentos e melhorias na infraestrutura.
